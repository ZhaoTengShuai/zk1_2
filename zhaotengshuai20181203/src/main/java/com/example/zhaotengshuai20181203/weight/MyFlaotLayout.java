package com.example.zhaotengshuai20181203.weight;
...
import com.example.zhaotengshuai20181203.R;

import java.util.ArrayList;

public class MyFlaotLayout extends LinearLayout {
    private int mScreenWidth;
    private int getmScreenHeight;
    private String mColor;

    public MyFlaotLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private TextView getText(){
        ...
        textView.setBackgroundResource(R.drawable.style_view);
